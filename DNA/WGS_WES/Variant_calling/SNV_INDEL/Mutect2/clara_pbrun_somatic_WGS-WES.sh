...
BAM_NORMAL=${BAM_DIR}/${PATIENT}_normal_WGS.recal.bam
...
echo ">>> Starting Parabricks Somatic pipeline for patient ${PATIENT} (WGS Normal vs WES Tumor)"
